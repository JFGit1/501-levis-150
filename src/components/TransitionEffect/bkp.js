...
const TransitionEffect = () => {
	return (
		<>
			<motion.div
				className='fixed top-0 z-[99] h-screen w-screen origin-top bg-primary'
				initial={{ scaleY: '0%' }}
				animate={{ scaleY: '0%' }}
				exit={{ scaleY: ['0%', '100%'] }}
			...
			/>
			<motion.div
				className='fixed bottom-0 z-[99] h-screen w-screen origin-bottom bg-primary'
				initial={{ scaleY: '100%' }}
				animate={{ scaleY: '0%' }}
			...
			/>
			<motion.div
				className='fixed bottom-0 z-[97] h-screen w-screen origin-bottom bg-neutral-300 opacity-95'
				initial={{ scaleY: '100%' }}
				animate={{ scaleY: '0%' }}
				transition={{
					delay: 0.3,
